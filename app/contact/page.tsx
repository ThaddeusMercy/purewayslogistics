...
type FormStatusType = "success" | "error" | "idle";
...
const Contact: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Hero */}
      <section
        className="pt-56 pb-32 md:pt-72 md:pb-44 relative overflow-hidden bg-cover bg-center"
        style={{ backgroundImage: `url('images/newimg2.png')` }}
      >
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white mb-8">
              Have questions about our Courier Firm? Reach out to our team and
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            {formStatus.type !== "idle" && (
              <div
                className={`p-4 my-4 rounded-lg ${formStatus.type === "success" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
              >
                {formStatus.message}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-6">
              ...
              <div>
                <button
                  ...
                  className="bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200 disabled:bg-orange-300"
                >
                    ...
                    {item.details.map((detail, i) => (
                      <p key={i} className="text-secondary-700">
                        {item.title === "Phone Numbers" ? (
                          <a
                            href="tel:+447544415535"
                            className="text-secondary-700 hover:text-accent-500 transition-colors"
                          >
                            {detail}
                          </a>
